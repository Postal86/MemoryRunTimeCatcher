...
namespace MemoryOffsetLocator.Engine.Common.DataStructures
{
    ...
    { 
        ...
        void ICollection<KeyValuePair<TFirst, TSecond>>.Add(System.Collections.Generic.KeyValuePair<TFirst, TSecond> item)
        {
        ...
        /// <summary>
        /// Removes the first occurrence of the specific object from this dictionary.
        /// </summary>
        ...
        void  ICollection<KeyValuePair<TFirst, TSecond>>.CopyTo(System.Collections.Generic.KeyValuePair<TFirst, TSecond>[] array, int arrayIndex)
        {
        ...
        /// <summary>
        /// Called when this object is de-serialized to reconstruct this object.
        /// </summary>
